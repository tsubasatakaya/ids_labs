...
# 4: Bottom margin, set to 4 lines.
# 4: Left margin, set to 4 lines.
# 0.1: Top margin, set to 0.1 lines (very small).
# 0.1: Right margin, set to 0.1 lines (very small)

# you can also use par(mfrow = c(no. rows, no. columns))
# par(mfrow = c(2, 2))  # Creates a 2x2 grid (4 plots total)
